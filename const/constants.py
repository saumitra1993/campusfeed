import os
import logging
test_server = os.environ.get('APPLICATION_ID', '') == 's~campusfeedapp-1097'
...
if dev_server:
	...
	DEFAULT_ROOT_URL = 'http://campusfeedapp-1097.appspot.com/'
	DEFAULT_ROOT_IMG_URL = 'http://campusfeedapp-1097.appspot.com/pic/'
	DEFAULT_ROOT_FILE_URL = 'http://campusfeedapp-1097.appspot.com/files/'
	GCM_PUSH_MESSAGE_API_KEY = "AIzaSyAl7wfc-zotdnymDMZUTazu4QR_rFYlB2Q"
